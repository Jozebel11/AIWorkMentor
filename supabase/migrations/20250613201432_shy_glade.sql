...
-- This file contains all the static data from your TypeScript files converted to SQL
...
-- Insert Job Prompt Structures for Teacher
...
-- Insert Job Prompt Structures for Writer
INSERT INTO job_prompt_structures (job_id, title, description, example, order_index) VALUES
...
('writer', 'Draft Enhancement', 'Improve existing content for clarity, flow, and engagement', 'Review this [type of content] draft and suggest improvements:
...
Draft: [paste content here]', 2),
('writer', 'Style Adaptation', 'Adapt content for different audiences, platforms, or formats', 'Adapt this content about [topic] for a new context:
...
('teacher-lesson-planning', 'teacher', 'AI-Powered Lesson Planning', 'Create comprehensive, engaging lesson plans using AI to save time and improve educational outcomes.', 'Beginner', '30-45 minutes', ARRAY['chatgpt'], '[
  ...
  {"title": "Generate Lesson Structure", "content": "Use AI prompts to create a detailed lesson structure including warm-up, main instruction, practice, and assessment components."},
  {"title": "Create Engaging Activities", "content": "Ask AI to suggest interactive activities and hands-on experiences that match your learning objectives and student needs."},
  ...
  {"title": "Plan for Differentiation", "content": "Generate modifications and accommodations for diverse learners using AI suggestions tailored to your specific student population."}
]'::jsonb),

('developer-code-review', 'developer', 'AI-Assisted Code Review', 'Use AI tools to improve code quality, catch bugs, and learn best practices through intelligent code analysis.', 'Intermediate', '20-30 minutes', ARRAY['chatgpt', 'copilot'], '[
  ...
  {"title": "Run AI Analysis", "content": "Use AI tools to analyze your code for potential bugs, performance issues, and adherence to best practices."},
  {"title": "Review Security Concerns", "content": "Ask AI to specifically check for security vulnerabilities and suggest improvements."},
  {"title": "Optimize Performance", "content": "Get AI suggestions for performance optimizations and more efficient algorithms."},
  {"title": "Implement Improvements", "content": "Apply the AI suggestions while maintaining your code''s functionality and adding proper documentation."}
]'::jsonb);
